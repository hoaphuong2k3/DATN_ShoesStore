...
import { Row, Col, Button, Input, InputGroup, InputGroupAddon, InputGroupText, Modal, ModalBody, ModalFooter, ModalHeader, Card, CardHeader, CardBody, CardFooter } from "reactstrap";
...
const Received = (props) => {
    ...
    const getAllConfirm = async () => {
        try {
            const response = await axios.get(`http://localhost:33321/api/order/order-detail/${storedUserId}?status=6`);
