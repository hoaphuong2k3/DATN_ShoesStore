...
const Received = (props) => {
    ...
    const getAllConfirm = async () => {
        try {
            const response = await axiosInstance.get(`http://localhost:33321/api/order/order-detail/${storedUserId}?status=6`);
                                    ...
                                    >
                                        <div className="p-5 pt--5">
                                            ...
                                            >
                                                ...
                                                <li className="step0 active text-muted text-center" id="step42"></li>
                                                <li className="step0 active text-muted text-end" id="step52"></li>
                                            </ul>
