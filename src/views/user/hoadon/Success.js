...
import { Badge, Row, Col, Button, Table, Input, FormGroup, InputGroup, InputGroupAddon, InputGroupText, Modal, ModalBody, ModalFooter, ModalHeader, Label, Form, Card, CardBody, CardFooter, CardHeader } from "reactstrap";
...
const Success = (props) => {
    ...
    const getAllConfirm = async () => {
        try {
            const response = await axios.get(`http://localhost:33321/api/order/order-detail/${storedUserId}?status=3`);
